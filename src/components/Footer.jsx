...
import { Instagram, Twitter, Pinterest, Room, Phone, Email} from '@mui/icons-material';
...
const Footer = () => {
    return (
        <Container>
            <Left>
                <Logo>APP</Logo>
                <Desc>There are many variations of passages of Lorem Ipsum avalaible.</Desc>
                <SocialContainer>
            ...
            <Right>
                ...
                <ContactItem><Email style = {{marginRight:"10px"}}/>contact@app.com</ContactItem>
